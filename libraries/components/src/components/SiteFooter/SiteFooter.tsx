...
function GameSection({ headline, games }: { headline: string; games: IGame[] }): JSX.Element {
	return (
		<VerticallyPaddedContainer
			...
			slotHeader={<S.SiteFooterHeadline>{headline}</S.SiteFooterHeadline>}>
	...
	return (
		<ContentContainer>
			<VerticallyPaddedContainer spacing={200}>
				<S.SiteFooter>
					<VerticallyPaddedContainer omit='top' slotHeader={<LogoTextInline />} slotHeaderSpacing={50} spacing={100}>
